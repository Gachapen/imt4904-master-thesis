...
With the two best ranks (0.97 and 0.91) and three worst ranks (0.27, 0.34, 0.40) removed, thus looking only at the ``middle'' part, the dRank distance is 5.21, still with a p-value of 0, and Kendall's tau is -0.33 (p >= 0.05), indicating no correlation in either direction.
