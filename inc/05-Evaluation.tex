...
\subsubsection{Simulated Annealing}
Figure~\ref{fig:sa-uniform} shows a comparison of L-system populations generated by an SA-optimized distribution and a uniform distribution.
The uniform distribution has a mean fitness score of 0.00, while the SA-optimized distribution's mean is 0.61.
There is a statistically significant difference between the populations (p < 0.01).
