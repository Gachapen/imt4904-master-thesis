...
%
% data:  ranking_human and ranking_code
% T = 51, p-value = 0.006885
...
% Describe how occupations and educations were selected.
...
% Analyse plant plant like/work and video game.
...
Clearly, there is a big disagreement between the humans and the fitness on these two, which should be studied.
...
\begin{table}
    ...
    \hline
    \end{tabularx}
    \caption{Improving or deterioating features}
...
\begin{table}
    ...
    \hline
    \end{tabular}
    \caption{Distinguishing features}
    \label{tab:distinguish2}
\end{table}
