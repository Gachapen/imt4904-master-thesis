...
To see if it is doing this, it needs to be compared to a brute-force approach that finds completely random samples in the sapce and picks the best of them.
Thus, the hypothesis is that DGEL GE finds plants with better fitness scores than brute-force does.
...
Depth 1 is mostly producing operators, but also an ooccasionalvariable, thus being useful and producing the lateral branches seen on the plant.
