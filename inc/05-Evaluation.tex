...
\begin{table}
    ...
    \hline
    more leaves & More leaves is postive & 5 \\
    \hline
    balanced leaves & Balanced amount of leaves is postive & 2 \\
    \hline
...
There was only one participant who suggested the oppisite, i.e. that artificial-looking plants looked good, or more specifically ``interesting [...] as I do not expect to see a lot of symmetry in plants''.

``more leaves'' was the second most occuring category (5 comments).
...
The third most occuring category is ``detail'', which says that a higher level of detail in the plants is a positive factor.
...
\begin{table}
    ...
    symmetry, assymetry, patterns, even spread, form, small, curves, upwards, sideways, complexity, visible branches, balanced, uniform bend, branch amount, straight, branch placement &
...
The abstract group contains factors that are not quantifiable and thus more abstract in nautre.
