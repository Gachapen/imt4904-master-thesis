...
% TODO: Elitism has not been introduced - do we assume reader will know what it is?
They find indications that ``elitism is required to ensure that good solutions are kept and built on, not lost or mutated in the next generation'', and therefore assigns 20\% of the population to be elites.~\cite{2009Beaumont}
