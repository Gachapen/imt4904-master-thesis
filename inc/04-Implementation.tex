...
% TODO: it feels wrong to read WILL (future tense) in a report about work that has been already done. You should rephrase it to past or at least present perfect tense.

\section{Overview}
% TODO: somewhat because of the use of passive voice, it is not clear what you have implemented, and what is provided by others or standard crates in RUST. Make it clear what was part of THIS project, and which facilities THIS project relies on from outside.
